			...
			case INTERRUPT_SOFTWARE: // System calls
				switch( cmd ) {
					case BOOT:
						...
						fs = new FileSystem(69); // change this im not sure what diskblocks should be
					...
					case CLOSE:   // to be implemented in project
						if((myTcb = scheduler.getMyTcb()) != null) {
							FileTableEntry ftEnt = myTcb.getFtEnt(0); //figure out what param should be
							if(ftEnt == null || fs.close(ftEnt) == false) return ERROR;
							if(myTcb.returnFd(0) != ftEnt) return ERROR; //figure out what param should be
							return OK;
						}
						return ERROR;
					case SIZE:    // to be implemented in project
						if((myTcb = scheduler.getMyTcb()) != null) {
							FileTableEntry ftEnt = myTcb.getFtEnt(0);
							if(ftEnt != null) return fs.fsize(ftEnt);
						}
						return ERROR;
					case SEEK:    // to be implemented in project
						return OK;
					case FORMAT:  // to be implemented in project
						return (fs.format(0) == true) ? OK : ERROR; //figure out what param is supposed to be
					case DELETE:  // to be implemented in project
						//figure out what param is supposed to be
						return (fs.delete("What the fuck is this supposed to be") == true) ? OK : ERROR;
				}
				return ERROR;
